...
public class DOMBuilderTest {
    ...
    @BeforeTest
    public void configure() throws SAXException, ParserConfigurationException, ParserException {
        DomParser parser = new DomParser();
        Schema schema = XMLSchemaFactory.getSchema(PathStorage.getInstance().getXsdPath());
        parser.setSchema(schema);
        builder = new DOMBuilder(parser.getDocument(new ByteArrayInputStream(xml.getBytes())));
    }
    ...
    public void buildTest(){
        ...
        assertTrue(builder.buildGemSet().contains(gem));
